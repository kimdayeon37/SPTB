...
const addWriter = () => {
  ...
  writers.value.push({
    ...
    invalidFunction: inputedWriterInvalidFucntion.value ? '1' : '0',
    invalidLength: inputedWriterInvalidLength.value ? '1' : '0',
    byteSwap: inputedWriterByteSwap.value ? '1' : '0',
    wordSwap: inputedWriterWordSwap.value ? '1' : '0',
