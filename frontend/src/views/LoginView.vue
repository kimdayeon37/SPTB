  ...
  <div class="column items-center">
    ...
    <div class="col" v-if="!userStore.isLogin()" style="max-width: 400px; margin-top: -100px">
      ...
      <q-form @submit="onSubmit" class="q-gutter-md">
        <q-input filled v-model="id" label="아이디 *" lazy-rules :rules="[(val: string | any[]) => (val && val.length > 0) || '아이디를 입력해주세요']" />
        ...
        <q-input filled v-model="pw" type="password" label="비밀번호 *" lazy-rules :rules="[(val: string | any[]) => (val && val.length > 0) || '비밀번호를 입력해주세요']" />
        <div>
